...
# === Your variables list ===
variables = [
    ["D-36L00040A-1200PRd:MassFlow",                    "kg/h"],          # 13050-01 FULLA PRODUCTION FLOWLINE 
    ["F1_pf04:OutletStream.f",                          "kg/h"],          # 18011-01- F1
    ["F3_pf04:OutletStream.f",                          "kg/h"],          # 18011-01- F3
    ["F6_pf04:OutletStream.f",                          "kg/h"],          # 18011-01- F6
    ["D-20L02001A-1600PR:OutletStream.f",               "kg/h"],          # 20070-01 HP Separator 
    ["D-20VA006:Pressure",                              "barg"],          # 20070-01 HP Separator

    ["LedaBoundary_Rind_pv:OutletStream[0].f",          "kg/h"],          # 13040-01 RIND Production Flowline
    ["RD1_pf04:OutletStream.f",                         "kg/h"],          # 18051-01 RD1
    ["RD2_pf04:OutletStream.f",                         "kg/h"],          # 18051-01 RD2
    ["RD3_pf04:OutletStream.f",                         "kg/h"],          # 18051-01 RD3 (RDSLG)
    ["D-13L00103A-1400PRb:MassFlow",                    "kg/h"],          # From Manifold RIND to Main Production Manifold
    ["D-13L00104A-1400PRa_pv:OutletStream[0].f",        "kg/h"],          # From Manifold RIND to Main Test Manifold

    ["LedaBoundary_Langfjellet_pv:OutletStream[0].f",   "kg/h"],          # 13045-01 LANGFJELLET Production Flowline
    ["LF1_pf04:OutletStream.f",                         "kg/h"],          # 18051-01 LF1
    ["LF2_pf04:OutletStream.f",                         "kg/h"],          # 18051-01 LF2
    ["LF4_pf04:OutletStream.f",                         "kg/h"],          # 18051-01 LF04b5
    ["D-13L00203A-1400PRb:MassFlow",                    "kg/h"],          # From Manifold LANGFJELLET to Main Production Manifold
    ["D-13L00204A-1400PRa_pv:OutletStream[0].f",        "kg/h"],          # From Manifold LANGFJELLET to Main Test Manifold

    ["N-18L8100A-1200PRa_pv:OutletStream[0].f",         "kg/h"],          # 18050-01 LANGFJELLET SOUTH FLOWLINE  
    ["LF3_pf04:OutletStream.f",                         "kg/h"],          # 18051-01 LF3

    ["D-20VA001:Pressure",                              "barg"],          # Main Separator 
]

# === Example usage ===
project_name = "Oscillator_Analysis_Yggdrasil"  # Name of the project for the output file
state = 0
